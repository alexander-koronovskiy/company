Задача 1
найти xml файл
парсинг файла, копирование
решить проблемы с правами доступа, реализовать тесты

тестирование
файл xml найден
файл xml не найден
файл xml успешно прочитан
файлы, указанные на xml найдены
файлы, указанные на xml не найдены
копирование прошло успешно (интеграционный тест)
